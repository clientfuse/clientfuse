import { IAgencyResponse, IFacebookInfo, IGoogleInfo, IGrantAccessResponse, TPlatformNamesKeys, AccessType, IFindOptions, TConnectionLinkResponse } from '@clientfuse/models';
